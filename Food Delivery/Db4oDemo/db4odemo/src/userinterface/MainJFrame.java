...
public class MainJFrame extends javax.swing.JFrame {
    ...
    /*void createInstances(){
        Employee emp1= system.getEmployeeDirectory().createEmployee("EMployee1");
        ArrayList<Role> roleList = system.getSupportedRole();
        UserAccountDirectory uadir = system.getUserAccountDirectory();
        //creating some instances as asked
        for(Role r: roleList)
        {
           // if(r.)
        }
        //Role custRole = 
        uadir.createUserAccount("Aditi", "abc", emp1, new CustomerRole());
    }*/
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
        ...
        //JPassword field returns charArray
        char[] passwordCharArr = (passwordField.getPassword());
        String password = String.valueOf(passwordCharArr);
        //authenticate
